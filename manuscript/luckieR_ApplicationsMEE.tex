...
Woods in Indiana, USA~\ref{2023:mille.fowle.ziegl.ea} and contains
...
\begin{figure}[htb]
  ...
  \caption{The probability that an individual is endophyte-positive
    (black) or -negative (red) given their LRO.  Axis tics are at the
    75th, 90th, 95th percentiles, and the plot extends to the 99th
    percentile.}
  \label{fig:ELRIfigs}
\end{figure}
